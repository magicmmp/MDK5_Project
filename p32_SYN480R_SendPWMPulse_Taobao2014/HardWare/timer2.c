...
*/
const uint16_t NEC_ARR[5]={800,1600,100,150,20};
const uint16_t NEC_CCR[5]={200,700,50,100,5};
const uint8_t NEC_DATA[5]={0x78,0x56,0x34,0x12,0x11};
