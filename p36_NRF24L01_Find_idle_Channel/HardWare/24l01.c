...
{ 	
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_4;	//推挽
...
//检测24L01是否存在
//尝试设置发送地址TX_ADDR，看能不能成功
//返回值:0，成功;1，失败	
u8 NRF24L01_Check(void)
{
	u8 buf[5]={0XA5,0XA5,0XA5,0XA5,0XA5};
	u8 i;
	SPIx_SetSpeed(SPI_BaudRatePrescaler_4); //spi速度为9Mhz（24L01的最大SPI时钟为10Mhz）   	 
...
void NRF24L01_RX_Mode(void)
{
	NRF24L01_CE=0;	  
  	...
  	NRF24L01_Write_Reg(NRF_WRITE_REG+RF_CH,8);	     //设置RF通信频率		  
...
{														 
	NRF24L01_CE=0;	    
  	...
  	NRF24L01_Write_Reg(NRF_WRITE_REG+RF_CH,8);       //设置RF通道为40
  	NRF24L01_Write_Reg(NRF_WRITE_REG+RF_SETUP,0x07);  //设置TX发射参数,0db增益,2Mbps,低噪声增益开启   
